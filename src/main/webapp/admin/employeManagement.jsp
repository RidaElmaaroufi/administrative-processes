	...
	<%if((boolean)session.getAttribute("connected")==false) {
		...
		<div id="page-wrapper">
				<header id="header">
					...
					<nav id="nav">
						<ul>
							...
							<li><a href="#" style="border-bottom: 2px solid aqua; color: #FFFF; font-family: bold">Employés</a></li>
				...
				<section style="position:absolute; top:30%;right: 5%; background-color: gray; border-radius: 10px; width:45rem">
					<span style="font-weight:16px;font-size: 18px; color : aqua;display:block; text-align:center">Gestion Des Employés</span>
					<div style="background-color:black">
						<table border='2' class="table table-striped">
						    ...
						    <c:forEach items="${employes}" var="employe">
							    <tr>
							      <td style="color:#FFFF;font-family:bold">${employe.getID()} </td>
							      <td style="color:#FFFF;font-family:bold">${employe.getNom()}</td>
							      <td style="color:#FFFF;font-family:bold">${employe.getPrenom()}</td>
							      <td style="color:#FFFF;font-family:bold">${employe.getUsername()}</td>
							      <td style="color:#FFFF;font-family:bold">${employe.getPassword()}</td>
							   </tr>
					...
					<div style="float: right">
						<button style="marging-top: 10rem; color : aqua"><a href="./HtmlAdd/FormEmploye.html">ajouter un employé </a></button>
					</div>
				</section>
